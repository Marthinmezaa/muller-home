...
- Próximo paso: identidad visual definitiva es Fase 2 (post-validación con cliente) — la paleta actual es provisoria a propósito. Definir con Marthin si el rediseño visual arranca ahora o después de validar el MVP con el cliente.
