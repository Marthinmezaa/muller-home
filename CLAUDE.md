...
- Próximo paso: alta/edición de propiedad desde el panel (formulario + carga de media a R2) — spec propia — o aplicar la paleta de marca más a fondo — a definir con Marthin.
