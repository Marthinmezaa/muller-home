...
- Próximo paso: aplicar la paleta de marca más a fondo, o el panel de franquicia/super admin (aprobar/rechazar solicitudes de baja, gestión de paquetes) — a definir con Marthin.
